...
class PrinterViewModel @Inject constructor(
    ...
    var serverPrinterModels by mutableStateOf<List<com.tokendad.nesventory.data.remote.PrinterModelInfo>>(emptyList())
    ...
    private var serverUrl by mutableStateOf(com.tokendad.nesventory.util.Constants.DEFAULT_REMOTE_URL)
    ...
    private fun loadSettings() {
        viewModelScope.launch {
            ...
            config = config.copy(density = initial.localPrinterDensity)
