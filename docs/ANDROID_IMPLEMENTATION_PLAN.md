...
- [x] **OIDC & Authelia Support (v6.4.0):**
...
- [x] **AI-Powered Item Enrichment (v6.1.2+):**
...
- [x] **Image-based Detection (v6.3.1):**
...
- [x] **International Formats (v6.5.0):**
